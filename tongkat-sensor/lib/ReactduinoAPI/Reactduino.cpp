...
Reactduino::Reactduino(react_callback cb) : _setup(cb), _onConnectionEstablished(cb), _button1_cb(cb) //tambahan callback buat mqtt
{
}
...
void Reactduino::onConnectionEstablished(void)
{
    _onConnectionEstablished();
}

void Reactduino::button1_cb(void)
{
    _button1_cb();
}
